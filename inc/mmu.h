...
#define PTE_PAGE   (1 << 1)
#define PTE_TABLE  (1 << 1)  /* entry gives address of the next level */
...
/*
 * Intermediate physical address size 32 bits, 4 GB
 * If {I}PS is programmed to a value larger than the implemented PA size, then
 * the PE behaves as if programmed with the implemented PA size, but software
 ...
 *   - TCR_ELx.T0SZ specifies the size for the lower VA range,
 *     translated using TTBR0_ELx.
 *   - TCR_ELx.T1SZ specifies the size for the upper VA range,
 *     translated using TTBR1_ELx.
 * The maximum TxSZ value is 39. If TxSZ is programmed to a value larger than 39
 * then it is IMPLEMENTATION DEFINED whether:
 *   - The implementation behaves as if the field is programmed to 39 for all
 *     purposes other than reading back the value of the field.
 *   - Any use of the TxSZ value generates a Level 0 Translation fault for the
 *     stage of translation at which TxSZ is used.
 */
#define TCR_T0SZ        (64 - 48)
#define TCR_T1SZ        ((64 - 48) << 16)
#define TCR_TG0_4K      (0 << 14)
#define TCR_TG1_4K      (2 << 30) /* Granule size for ttbr1_el1 4 KB */
...
#define TCR_VALUE                                                              \
    (TCR_T0SZ | TCR_T1SZ | TCR_TG0_4K | TCR_TG1_4K | TCR_SH0_INNER             \
     | TCR_SH1_INNER | TCR_ORGN0_IRGN0 | TCR_ORGN1_IRGN1 | TCR_IPS)
